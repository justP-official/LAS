...
urlpatterns = [
    ...
    path('update-lesson/<int:lesson_id>/', views.UpdateLessonView.as_view(), name='update_lesson'),
    path('delete-lesson/<int:lesson_id>/', views.DeleteLessonView.as_view(), name='delete_lesson'),
